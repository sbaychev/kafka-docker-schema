...
import co.sample.kafka.config.UnitTestConfig.KafkaListenerTestHarness;
import co.sample.kafka.consumer.ConsumerService;
...
@EmbeddedKafka(
        partitions = 1,
        topics = SampleKafkaConsumerTest.TEST_CONSUMER_TOPIC)
@DirtiesContext
